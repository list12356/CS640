...
if __name__ == '__main__':
	...
	os.mkdir('Q3')
    f2=open('Q3/result_Q3_3.txt','w')
    h1.cmd("java Iperfer -s -p 8000 &")
    h4.sendCmd("java Iperfer -c -h 10.0.0.1 -p 8000 -t 20")
    h9.sendCmd("java Iperfer -c -h 10.0.0.7 -p 8000 -t 20")
    h8.cmd("java Iperfer -s -p 8000 &")
    h7.cmd("java Iperfer -s -p 8000 &")
    h10.sendCmd("java Iperfer -c -h 10.0.0.8 -p 8000 -t 20")
    result1=h9.waitOutput()
    result2=h10.waitOutput()
    result3=h4.waitOutput()
    f2.write(result1)
    f2.write(result2)
    f2.write(result3)
     #CLI( net )
