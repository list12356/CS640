...
if __name__ == '__main__':
    ...
    if os.path.isdir('Q4')==False:
	os.mkdir('Q4')
    f1=open('Q4/latency_h1-h4.txt','w')
    f2=open('Q4/latency_h5-h6.txt','w')
    f3=open('Q4/throughput_h1-h4.txt','w')
    f4-open('Q4/throughput_h5-h6.txt','w')
    h1.sendCmd("java Iperfer -s -p 8000")
    h4.sendCmd("java Iperfer -c -h 10.0.0.1 -p 8000 -t 20")
    h5.sendCmd("java Iperfer -s -p 8000")
    h6.sendCmd("java Iperfer -c -h 10.0.0.5 -p 8000 -t 20")
